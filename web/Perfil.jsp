                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach var="us" items="${usuarios}">
                                <tr>
                                    ...
                                    <td>${us.getTipodep()}</td>
                                    <td>
                                        <a class="btn btn-warning" href="Controlador?menu=Perfil&accion=Editar&id=${us.getId()}">Editar</a>
                                        <a class="btn btn-danger" href="Controlador?menu=Perfil&accion=Delete&id=${us.getId()}">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
